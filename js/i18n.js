...
const translations = {
  de: {
    ...
    btnDriveSetup:              '☁️ Ordner einrichten',
    btnDriveBackup:             '☁️ Jetzt sichern',
    btnDriveRestore:            '↩ Wiederherstellen',
    btnDriveChange:             'Ordner ändern',
    drivePickerFolderTitle:     'Backup-Ordner auswählen',
  ...
  es: {
    ...
    btnDriveSetup:              '☁️ Configurar carpeta',
    btnDriveBackup:             '☁️ Guardar ahora',
    btnDriveRestore:            '↩ Restaurar',
    btnDriveChange:             'Cambiar carpeta',
    drivePickerFolderTitle:     'Seleccionar carpeta de copias',
